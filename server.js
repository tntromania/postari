...
app.get('/api/auth/facebook', authenticate, (req, res) => {
    const params = new URLSearchParams({
        ...
        scope: 'pages_manage_posts,pages_read_engagement,instagram_basic,instagram_content_publishing,pages_show_list,business_management',
        state:         req.userId,
        response_type: 'code'
    });
...
async function postToTikTok(post, account) {
    // ← Citim ÎNTOTDEAUNA dimensiunea reală de pe disc
    ...
    const initRes = await fetch('https://open.tiktokapis.com/v2/post/publish/video/init/', {
        ...
        body: JSON.stringify({
            ...
            source_info: { 
                source:            'FILE_UPLOAD', 
                video_size:        fileSize,  // ← real
                chunk_size:        fileSize,  // ← identic cu video_size
                total_chunk_count: 1 
            }
        })
    });
